...
Button(root,text="C", width=5, height=1, font=("arial",30,"bold"), bd=1, fg="#fff",bg="#2a2b36", command=lambda: clear()).place(x=10, y=100)
...
Button(root,text="=", width=5, height=3, font=("arial",30,"bold"), bd=1, fg="#fff",bg="#2a2b36", command=lambda: calculate()).place(x=430, y=400)

Button(root,text="0", width=10, height=1, font=("arial",30,"bold"), bd=1, fg="#fff",bg="#2a2b36", command=lambda: show("0")).place(x=10, y=500)
